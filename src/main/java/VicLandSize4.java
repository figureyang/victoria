...
/**
 * Created by jingfeiyang on 17/2/17.
 */
public class VicLandSize4 {
    public static void main(String[] args) throws Exception{
        ...
        Thread thread2 = new VicThread4(readfile2,writefile2,driver);
...
class VicThread4 extends Thread
{
    ...
    public VicThread4(String readfrom,String writeto, String driverPath)
    {
...
///////////get the last line of the result file////////////////////////////
        ...
        try
        {
            ...
            while ((nextLine0 = reader.readNext()) != null) {
                counter = Integer.parseInt(nextLine0[10]);
            }
        }
        catch (Exception e)
        {
        ...
        try
        {
            ...
            while((nextLine=reader.readNext())!=null)
            {
                ...
                int counter1 = Integer.parseInt(nextLine[10]);
                ...
                if(counter1 == (counter + 1))
                {
                    try
                    {
                        ...
                        try {
                            ...
                            String entry[] = {proID, proType, address, area, state, postcode, Lati, Lng, landSize, sizeUnit, counter1+""};
