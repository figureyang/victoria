...
/**
 * Created by jingfeiyang on 17/3/9.
 */
public class VicLandSize6 {
    public static void main(String[] args) throws Exception{
        ...
        Thread thread2 = new VicThread6(readfile2,writefile2,driver);
...
class VicThread6 extends Thread
{
    ...
    public VicThread6(String readfrom,String writeto, String driverPath)
    {
